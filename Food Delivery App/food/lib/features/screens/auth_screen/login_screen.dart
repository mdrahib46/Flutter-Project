                    ...
                    child: Row(
                      ...
                      children: [
                        SocialMediaIconButton(
                          color: AppColors.fbIconBg,
                          imgPath: AppImages.fbIcon,
                          onTap: () {},
                        ),
                        const SizedBox(width: 24),
                        SocialMediaIconButton(
                          color: AppColors.xIconBg,
                          imgPath: AppImages.xIcon,
                          onTap: () {},
                        ),
                        const SizedBox(width: 24),
                        SocialMediaIconButton(
                          color: AppColors.appleIconBg,
                          imgPath: AppImages.appleIcon,
                          onTap: () {},
                        ),
                      ],
                    ),
